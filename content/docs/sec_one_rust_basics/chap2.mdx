...
```rust title="Comments and Documentation"
// Line comments are created using two slashes
...
//! Typically placed at the top of src/lib.rs or a module file
```

## Exercises

1. **Variable Practice**
   Create variables of different types and try to modify them:
   ```rust
   // TODO: Create immutable and mutable variables
   // TODO: Try to modify an immutable variable and observe the error
   // TODO: Create variables of different numeric types
   ```
...
<Cards>
  <Card
    ...
    href="/chapter-3"
  >
    Learn about Rust's powerful pattern matching capabilities
  </Card>
  ...
  <Card
    ...
    href="/chapter-4"
  >
    Discover how Rust handles errors and exceptions
  </Card>
</Cards>
...
```rust title="exercises/control_flow.rs"
fn main() {
    // Exercise 1: FizzBuzz
